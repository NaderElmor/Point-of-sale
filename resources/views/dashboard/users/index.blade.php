                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">@lang('site.users')
                            <a href="{{route('dashboard.users.index')}}"></a>
                        </li>
                    </ol>
            ...
            <form action="{{route('dashboard.users.index')}}">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <a href="{{route('dashboard.users.create')}}" class="btn btn-primary btn-sm">@lang('site.add')
                ...
                <tbody>
                    ...
                    <td><img src="{{$user->image_path}}" style="width:90px" class="img-responsive img-thumbnail" alt=""></td>
                        ...
                        <td>
                            ...
                            <a href="{{route('dashboard.users.edit', $user->id)}}" class="btn btn-primary">@lang('site.edit')
                            ...
                            @endif @if(auth()->user()->hasPermission('delete_users'))
                            <form
                                ...
                                {{ csrf_field() }}
                                {{ method_field('delete') }}
                                <button type="submit" class="btn btn-danger delete"><I class="fa fa-remove"></I>
                                    @lang('site.delete')
                                </button>
                            </form>
                            @else
